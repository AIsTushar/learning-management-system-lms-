                    ...
                    <div class="card-body">
                        <form method="post" class="row" action="{{route('instructor.register')}}">
                            ...
                            <div class="input-box col-lg-6">
                                ...
                                <div class="form-group">
                                    <input class="form-control form--control @error('username') is-invalid @enderror" type="text" name="username" placeholder="e.g. Alex_smith">
                                    @error('username')
                                        <span class="text-danger">{{$message}}</span>
                                    @enderror
                                    <span class="la la-user input-icon"></span>
                            ...
                            <div class="input-box col-lg-6">
                                ...
                                <div class="form-group">
                                    <input class="form-control form--control @error('email') is-invalid @enderror" type="email" name="email" placeholder="e.g. Alex@gmail.com">
                                    @error('email')
                                        <span class="text-danger">{{$message}}</span>
                                    @enderror
                                    <span class="la la-user input-icon"></span>
                            ...
                            <div class="input-box col-lg-6">
                                ...
                                <div class="form-group">
                                    <input class="form-control form--control @error('phone') is-invalid @enderror" type="text" name="phone" placeholder="e.g. 0171234567">
                                    @error('phone')
                                        <span class="text-danger">{{$message}}</span>
                                    @enderror
                                    <span class="la la-user input-icon"></span>
                            ...
                            <div class="input-box col-lg-12">
                                ...
                                <div class="form-group">
                                    <input class="form-control form--control @error('address') is-invalid @enderror" type="text" name="address" placeholder="e.g. 1234 Main St">
                                    @error('address')
                                        <span class="text-danger">{{$message}}</span>
                                    @enderror
                                    <span class="la la-user input-icon"></span>
                            ...
                            <div class="input-box col-lg-12">
                                ...
                                <div class="form-group">
                                    <input class="form-control form--control " type="password" name="password" placeholder="e.g. 1234 Main St">
